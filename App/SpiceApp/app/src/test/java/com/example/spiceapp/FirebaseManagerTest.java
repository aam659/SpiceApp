...
//        Mock logging in
        ...
        mockedDatabaseReference.child("users").child(mockedFirebaseUser.getUid()).child("Moods").setValue(moods);
    ...
    public void getCurrentPreference() {
        ...
        // Set mocked user's name to firstName
        mockedDatabaseReference.child("users").child(mockedFirebaseUser.getUid()).child("CurrentPreference").child("name").setValue(currentPreference);
...
//        Mock logging in
        ...
        // Set mocked user's name to firstName
        mockedDatabaseReference.child("users").child(mockedFirebaseUser.getUid()).child("lName").setValue(lastName);
    ...
    public void getPhoneNumberReference() {
        ...
        // Set mocked user's name to firstName
        mockedDatabaseReference.child("users").child(mockedFirebaseUser.getUid()).child("phoneNumber").setValue(phone);
